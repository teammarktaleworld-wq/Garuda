...
//   model: string;
//   variantLabel?: string;
//   powertrain: Powertrain;           // ← added: drives the wizard step 2
//   category: Category;
//   modelYear: ModelYear;
//   consumerOffer?: number;
//   exchangeBenefit?: number;
...
export const VEHICLE_DETAILS: Record<string, VehicleDetail> = {
  ...
  sierra: {
    ...
    mileage: "~17 kmpl (est.)",
    specifications: {
      engine: "1.5 L Revotron Turbo Petrol / Electric",
      power: "~163 bhp (Petrol est.)",
      torque: "~280 Nm (Petrol est.)",
      transmission: "6-MT / 6-AT",
      seating: "5",
      mileage: "~17 kmpl (est.)",
    },
