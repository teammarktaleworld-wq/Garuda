...
// /* ════════════════════════════════════════════════════════════════════════
//    API HELPER — shared by both forms
//    Matches EnquiryBody in app/api/enquiry/route.ts: { name, mobile, car, source }
// ════════════════════════════════════════════════════════════════════════ */
...
// /* ════════════════════════════════════════════════════════════════════════
//    CUSTOM DROPDOWN — replaces native <select> so option list matches
//    the dark theme on every browser/OS (native <option> can't be themed).
//    Fully keyboard accessible, touch-friendly, closes on outside click / Esc.
// ════════════════════════════════════════════════════════════════════════ */
...
//           text-left text-[16px] sm:text-[13.5px]
...
//               rounded-xl border border-white/12 bg-[#0B1627]
//               shadow-[0_20px_50px_rgba(0,0,0,0.65)] p-1.5
...
//                   px-3.5 py-3 sm:py-2.5 rounded-lg cursor-pointer select-none
//                   text-[15px] sm:text-[13.5px]
//                   transition-colors duration-100
//                   ${i === highlighted ? "bg-[#0055A5]/25" : ""}
//                   ${value === opt ? "text-[#7DB8F7] font-semibold" : "text-white/75"}
//                 `}
//               >
//                 {opt}
...
//       "
//     >
//       {/* Ambient glow — hidden on mobile to cut paint cost */}
//       <div className="hidden sm:block absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full bg-[#0055A5]/15 blur-[120px] pointer-events-none" />
//       <div className="hidden sm:block absolute bottom-0 left-0 w-[300px] h-[300px] rounded-full bg-[#1A70D4]/8 blur-[90px] pointer-events-none" />
...
//                   px-7 py-3.5 rounded-full min-h-[48px]
//                   bg-[#0055A5] hover:bg-[#1A70D4] active:bg-[#1A70D4]
...
// /* ════════════════════════════════════════════════════════════════════════
//    MOBILE CARD — stacked, no image, larger tap targets
// ════════════════════════════════════════════════════════════════════════ */
...
//       className="bg-[#07101E] border border-white/[0.08] rounded-2xl p-4 sm:p-5 mb-3 last:mb-0"
//     >
//       <div className="flex items-start justify-between gap-3 mb-3">
//         <div className="min-w-0">
//           <ModelBadges offer={offer} />
//           <h3 className="text-white font-extrabold text-[1.02rem] tracking-tight mt-1.5 truncate">
//             {offer.model}
//           </h3>
//           <p className="text-white/38 text-[11px] mt-0.5 truncate">{offer.variantLabel ?? offer.category}</p>
//         </div>
...
//             value={offer.totalBenefit}
//             active={inView}
//             className="block text-white font-extrabold text-[1.35rem] tracking-tight leading-none"
//           />
...
//             py-3 rounded-lg min-h-[44px]
//             bg-[#0055A5] active:bg-[#1A70D4]
...
//             border border-white/12 active:border-white/28
...
// /* ════════════════════════════════════════════════════════════════════════
//    BACKGROUND ATMOSPHERE — heavy blur blobs skipped on mobile for perf
// ════════════════════════════════════════════════════════════════════════ */
// function Background() {
//   const prefersReduced = useReducedMotion();
//   return (
...
//       />
//       <motion.div
//         className="hidden sm:block absolute top-[8%] left-[10%] w-[700px] h-[700px] rounded-full bg-[#0055A5]/8 blur-[160px]"
//         animate={prefersReduced ? undefined : { x: [0, 50, -20, 0], y: [0, -40, 20, 0] }}
//         transition={{ duration: 50, repeat: Infinity, ease: "easeInOut" }}
//       />
//       <motion.div
//         className="hidden sm:block absolute bottom-[5%] right-[5%] w-[500px] h-[500px] rounded-full bg-[#1A70D4]/6 blur-[130px]"
...
// const fieldClass = "w-full bg-white/[0.05] border border-white/10 rounded-xl px-4 py-3.5 min-h-[52px] text-white text-[16px] sm:text-[13.5px] placeholder:text-white/25 focus:outline-none focus:border-[#0055A5]/65 focus:bg-[#0055A5]/[0.07] transition-colors duration-200";

// /* ════════════════════════════════════════════════════════════════════════
//    FULL ENQUIRY FORM (main section) — sends { name, mobile, car, source }
//    to /api/enquiry. Enquiry Type and Showroom are folded into `source`
//    so nothing is lost even though the API only persists those 4 fields.
// ════════════════════════════════════════════════════════════════════════ */
...
//   return (
//     <section id="enquiry" className="bg-[#050A12] py-16 sm:py-20 lg:py-28 px-5 lg:px-12 scroll-mt-0">
...
//           </h2>
//           <p className="text-white/45 text-[13.5px] sm:text-[14px] max-w-md mx-auto leading-relaxed">
//             Tell us what you're interested in and the Garud Tata team will get in touch with you.
//           </p>
//         </div>

//         <div className="bg-[#07101E] border border-white/[0.08] rounded-3xl p-5 sm:p-6 lg:p-8">
//           {submitted ? (
//             <motion.div
...
//                 Enquiry Received!
//               </h3>
//               <p className="text-white/45 text-[13.5px] sm:text-[14px] leading-relaxed mb-8 max-w-xs mx-auto">
...
//                   className="flex items-center justify-center gap-2 px-6 py-3.5 min-h-[48px] rounded-full bg-white/6 border border-white/18 active:border-white/35 text-white font-medium text-[12.5px] tracking-[0.04em] transition-colors duration-150"
//                 >
//                   WHATSAPP US
//                 </a>
//               </div>
...
//               {/* Car — custom dropdown, fixes native white popup */}
//               <CustomSelect
...
//                       className={`
//                         px-3.5 py-2.5 rounded-lg text-[12px] font-semibold tracking-[0.04em] min-h-[40px]
//                         border transition-colors duration-150
//                         ${form.type === t
//                           ? "bg-[#0055A5] border-[#0055A5] text-white"
//                           : "bg-white/[0.04] border-white/10 text-white/50 active:text-white active:border-white/25"}
//                       `}
//                     >
//                       {t}
//                     </button>
...
//                   py-4 rounded-xl mt-1 min-h-[52px]
//                   bg-[#0055A5] active:bg-[#1A70D4]
...
// /* ════════════════════════════════════════════════════════════════════════
//    QUICK OFFER MODAL — compact popup (Name, Mobile, Car) for fast capture.
//    Same /api/enquiry endpoint, source tagged "quick-offer-modal".
// ════════════════════════════════════════════════════════════════════════ */
...
//               bg-[#0B1627] border border-white/12
//               rounded-t-3xl sm:rounded-3xl
//               p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] sm:p-7
...
//               onClick={onClose}
//               aria-label="Close"
//               className="absolute top-4 right-4 w-9 h-9 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-white/50 active:text-white active:bg-white/10 transition-colors"
//             >
//               <X size={16} />
//             </button>
...
//                 <div className="w-12 h-12 rounded-full bg-[#0055A5]/20 border border-[#0055A5]/40 flex items-center justify-center mx-auto mb-4">
//                   <CheckCircle2 size={24} className="text-[#5BA3E8]" />
//                 </div>
//                 <h3 className="text-white font-extrabold text-[1.3rem] tracking-tight mb-2">
//                   Enquiry Received!
//                 </h3>
...
//                   type="button"
//                   onClick={onClose}
//                   className="w-full py-3.5 min-h-[48px] rounded-xl bg-[#0055A5] active:bg-[#1A70D4] text-white font-bold text-[12.5px] tracking-[0.06em] transition-colors"
//                 >
//                   DONE
//                 </button>
//               </div>
...
//                   </div>
//                   <div>
//                     <label className="block text-[10px] text-white/35 mb-1.5 tracking-[0.18em] uppercase font-bold">Mobile</label>
//                     <input
//                       type="tel"
//                       required
//                       inputMode="numeric"
...
//                   {error && (
//                     <p role="alert" className="text-red-400 text-[12.5px] leading-snug">{error}</p>
//                   )}
...
//                     className="
//                       w-full flex items-center justify-center gap-2
//                       py-3.5 min-h-[50px] rounded-xl
//                       bg-[#0055A5] active:bg-[#1A70D4]
//                       disabled:opacity-55 disabled:cursor-not-allowed
//                       text-white font-extrabold text-[13px] tracking-[0.07em]
//                       shadow-[0_6px_22px_rgba(0,85,165,0.4)]
//                       transition-colors duration-150
//                     "
//                   >
//                     {loading
...
//     <>
//       {/* ══════════════ OFFERS SECTION ══════════════ */}
//       <section id="offers" className="relative bg-[#050A12] pt-16 pb-24 sm:pt-20 sm:pb-16 lg:pt-28 lg:pb-20 overflow-hidden">
//         <Background />
...
//             </h2>
//             <p className="text-white/50 text-[13.5px] sm:text-[14.5px] max-w-lg mx-auto leading-relaxed mb-2">
//               Explore verified MY25 and MY24 consumer benefits available at Garud Tata.
//             </p>
//             <p className="text-white/30 text-[11.5px] sm:text-[12px] mb-2">
...
//               <span key={t} className="flex items-center gap-1.5 text-[11px] sm:text-[11.5px] text-white/40 font-medium">
...
//           {/* CTA strip */}
//           <div className="mt-12 sm:mt-14 text-center bg-white/[0.03] border border-white/[0.07] rounded-2xl px-5 sm:px-6 py-9 sm:py-10 lg:py-12">
//             <h4 className="text-white font-bold text-[1.2rem] sm:text-[1.35rem] tracking-tight mb-2">
//               Want to know which offer applies to you?
//             </h4>
//             <p className="text-white/42 text-[13px] sm:text-[13.5px] mb-6 max-w-sm mx-auto leading-relaxed">
//               Our Garud Tata team can help you confirm the applicable benefits for your model and variant.
//             </p>
//             <button
//               onClick={openQuickModal}
//               className="
//                 inline-flex items-center gap-2.5 px-8 py-3.5 min-h-[48px] rounded-full
//                 bg-[#0055A5] active:bg-[#1A70D4]
//                 text-white font-bold text-[12.5px] tracking-[0.07em]
...
//       {/* ══════════════ ENQUIRY SECTION (full form) ══════════════ */}
//       <EnquiryForm
//         preselectedCar={preselectedCar}
//         preselectedType={preselectedType}
//       />

//       {/* ══════════════ QUICK OFFER MODAL (compact popup) ══════════════ */}
...
//           bg-gradient-to-t from-[#050A12] via-[#050A12]/95 to-transparent
//         "
//       >
//         <button
//           onClick={openQuickModal}
//           className="
//             w-full flex items-center justify-center gap-2
//             py-3.5 min-h-[52px] rounded-full
//             bg-[#0055A5] active:bg-[#1A70D4]
//             text-white font-bold text-[13px] tracking-[0.06em]
//             shadow-[0_8px_28px_rgba(0,85,165,0.5)]
//             transition-colors duration-150
//           "
//         >
//           GET MY OFFER
