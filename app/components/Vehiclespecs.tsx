...
// import type { VehicleDetail } from "@/lib/tata-offers";
...
//   return (
//     <section ref={ref} className="bg-[#0a1425] py-14 sm:py-20 px-5 lg:px-12">
...
//           className="mb-8"
//         >
//           <span className="text-[10px] font-bold tracking-[0.26em] text-[#7DB8F7] uppercase mb-3 block">SPECIFICATIONS</span>
//           <h2 className="text-white font-extrabold text-[clamp(1.6rem,5vw,2.4rem)] tracking-tight">
//             About the {offer.model}
//           </h2>
//           {detail.description && (
//             <p className="text-white/45 text-[14px] leading-relaxed mt-3 max-w-2xl">
//               {detail.description}
//             </p>
//           )}
//         </motion.div>
...
//           className="inline-flex items-baseline gap-2 bg-[#0055A5]/12 border border-[#0055A5]/25 rounded-xl px-5 py-3 mb-8"
//         >
//           <span className="text-[10px] font-bold tracking-[0.2em] text-white/35 uppercase">Starting at</span>
//           <span className="text-white font-extrabold text-[1.3rem]">{detail.priceFrom}</span>
//         </motion.div>
...
//               className="bg-[#132035] border border-white/[0.07] rounded-xl p-4"
//             >
//               <Icon size={16} className="text-[#0055A5] mb-2.5" strokeWidth={2} />
//               <p className="text-[10px] font-bold tracking-[0.15em] text-white/28 uppercase mb-1">{label}</p>
//               <p className="text-white font-semibold text-[13.5px] leading-snug">{value}</p>
//             </motion.div>
//           ))}
//         </div>
//       </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3.5">
          {items.map(({ label, value, Icon }, i) => (
            <motion.div
              ...
              className="bg-white border border-slate-200 rounded-xl p-4.5 shadow-sm hover:border-[#0055A5]/40 hover:shadow transition-all duration-200"
            >
