...
// /* =========================================================
//    CITY INFORMATION
//    — On the root "/" route, always show "Delhi" with no image.
//    — On showroom sub-routes, use the showrooms config as before.
// ========================================================= */

// function useCityInfo() {
//   const pathname = usePathname();

//   // Root page → always Delhi, no GMB image
//   if (pathname === "/") {
//     return { cityName: "Delhi", gmbImage: null };
//   }
...
//       }`}
//     >
//       {/* Only show image on non-root routes where gmbImage exists */}
//       {gmbImage ? (
//         <img
//           src={gmbImage}
//           alt={cityName}
...
//   // On root page, never show a GMB image regardless of prop
//   const resolvedGmbImage = pathname === "/" ? null : (gmbImage ?? configGmbImage);
...
//                 <a href={telHref} className="flex-1 text-[15px] font-bold text-gray-800">
//                   {DISPLAY_PHONE}
//                 </a>
...
// /* =========================================================
//    PHONE
//    Single source of truth — used for display, tel: href,
//    and WhatsApp link everywhere across desktop and mobile.
// ========================================================= */

// const DISPLAY_PHONE = "+91 92173 71211";
// const RAW_PHONE     = "919217371211";   // digits only, no spaces or +
...
//   /* =======================================================
//      PHONE LINKS — always +91 92173 71211
//   ======================================================= */
...
//    CITY INFORMATION
//    — On the root "/" route, always show "Delhi" with no image.
//    — On showroom sub-routes, use the showrooms config.
//    — Slug format is now e.g. "Tata-Motors-Narela"
// ========================================================= */
...
//   // pathname e.g. "/Tata-Motors-Narela" → segment = "Tata-Motors-Narela"
//   const pathSlug = pathname.split("/")[1] as keyof typeof showrooms;
//   const slug     = pathSlug && showrooms[pathSlug] ? pathSlug : "Tata-Motors-Palam";
//   const config   = showrooms[slug];

//   // Extract city name from slug: "Tata-Motors-Narela" → "Narela"
//   const cityName = slug.split("-").pop() ?? slug;
...
import { showrooms, SHOWROOM_SLUGS, HOME_URL, type ShowroomSlug } from "@/app/config/showrooms";
import {
  trackCallClick,
  trackWhatsAppClick,
  trackCopyPhone,
...
type RouteNavLink = { label: string; href: string; type: "route"; hash: null };
type HashNavLink  = { label: string; href: string; type: "hash";  hash: string };
type NavLink      = RouteNavLink | HashNavLink;
...
/* =========================================================
   ...
   — "/Tata-Motors-Narela" etc → show switcher
========================================================= */
...
/* =========================================================
   MOBILE SHOWROOM SWITCHER (inside menu)
========================================================= */
...
/* =========================================================
   CITY BADGE (root "/" only — no dropdown)
========================================================= */
      ...
      >
        <div className="max-w-[1440px] mx-auto px-5 lg:px-12 h-full flex items-center justify-between gap-4">
          ...
          <div className="flex lg:hidden items-center gap-1.5">
            ...
            {/* Mobile: static badge on /, no dropdown trigger here (it's inside menu) */}
            {isShowroomRoute && currentSlug ? (
