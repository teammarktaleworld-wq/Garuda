...
//    Showrooms have website links instead of live map links.
// ========================================================= */
...
//     name: "Palam Showroom",
//     address:
//       "Garg Plaza, RZ A70, Dabri–Palam Rd, New Delhi 110045",
//     website: "https://www.tatamotors-delhi.com/palam",
//     type: "showroom",
//   },
//   {
//     name: "Narela Showroom",
//     address:
//       "Khasra No 42/12, Narela, New Delhi 110040",
//     website: "https://www.tatamotors-delhi.com/narela",
//     type: "showroom",
//   },
//   {
...
//     website: "https://www.tatamotors-delhi.com/najafgarh",
//     type: "showroom",
//   },
//   {
...
//                   {/* SHOWROOM — WEBSITE LINK */}
//                   {loc.type === "showroom" && loc.website ? (
//                     <a
//                       href={loc.website}
//                       target="_blank"
//                       rel="noopener noreferrer"
...
//                             <ExternalLink
//                               size={12}
//                               className="text-[#1E7FE8] opacity-70 group-hover:opacity-100 transition-opacity"
//                             />
//                           </div>
...
//                           <div className="text-[#1E7FE8] text-[11px] mt-1.5 font-medium">
//                             Visit Showroom Website →
//                           </div>
//                         </div>
...
//                     /* SERVICE CENTRE — ADDRESS ONLY */
//                     <div className="group block p-3 -mx-3 rounded-xl">
//                       <div className="flex items-start gap-3">

//                         <div className="mt-0.5 p-1.5 rounded-full bg-white/[0.03]">
//                           <MapPin
//                             size={15}
//                             className="text-[#1E7FE8]"
//                           />
...
//                           <div className="text-white/40 text-[13px] leading-relaxed line-clamp-2 pr-4">
//                             {loc.address}
//                           </div>
//                         </div>
...
//               <a
//                 href={PHONE_TEL}
//                 className="hover:text-[#1E7FE8] transition-colors"
//               >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4">
            ...
            <ul className="space-y-5">
              {locations.map((loc) => (
                <li key={loc.name}>
                  {/* SHOWROOM — Internal Next.js Link */}
                  {loc.type === "showroom" && loc.route ? (
                    <Link
                      href={loc.route}
                      className="group block p-3 -mx-3 rounded-xl hover:bg-white/[0.02] transition-colors"
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-white/40 text-[13px] leading-relaxed group-hover:text-white/60 transition-colors line-clamp-2 pr-4">
                            {loc.address}
                          </p>

                          <p className="text-[#1E7FE8] text-[11px] mt-1.5 font-medium">
                            Visit Showroom Page →
                          </p>
                        </div>
                      </div>
                    ...
                    /* SERVICE CENTRE — Address only */
                    <div className="p-3 -mx-3 rounded-xl">
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 p-1.5 rounded-full bg-white/[0.03]">
                          <MapPin
                            size={15}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-white/40 text-[13px] leading-relaxed line-clamp-2 pr-4">
                            {loc.address}
                          </p>
                        </div>
                      </div>
