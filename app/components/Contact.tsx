...
//   return (
//     <section id="contact" className="relative bg-[#0D1829] py-16 sm:py-20 lg:py-28 overflow-hidden">
//       {/* Background */}
...
//     <section id="contact" className="scroll-mt-20 lg:scroll-mt-24 relative bg-[#0D1829] py-16 sm:py-20 lg:py-28 overflow-hidden">
//       {/* Background */}
//       <div className="absolute inset-0 overflow-hidden pointer-events-none">
//         <div
//           className="absolute inset-0 opacity-[0.022]"
