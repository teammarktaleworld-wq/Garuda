    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-14 max-w-2xl">
          ...
          <p className="mt-4 text-base leading-7 text-gray-500">
            Stay updated with the latest Tata Motors news,
            vehicle launches, festive-season updates and
            automotive insights from Garud Tata Motors.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {prBlogData.map((article) => (
            <article
              key={article.id}
              className="group flex h-full flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#0055A5]/20 hover:shadow-[0_8px_32px_rgba(0,85,165,0.10)]"
            >
