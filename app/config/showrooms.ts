...
export const HOME_URL = "https://tatamotors-delhi.com/";
...
export const showrooms: Record<ShowroomSlug, ShowroomConfig> = {
  ...
  "Tata-Motors-Palam-Dwarka": {
    ...
    hero:           SHARED_HERO,
    seo: {
      title:       "Tata Motors Palam Dwarka | New Tata Cars, Offers & Test Drive | Garud Tata",
      description: "Visit Garud Tata Palam Dwarka, an authorised Tata Motors dealer in New Delhi. Explore new Tata cars, latest offers, test drives, finance and expert assistance.",
      canonical:   "https://www.tatamotors-delhi.com/Tata-Motors-Palam-Dwarka",
    },
    navbar: {
      logoSrc:  "/images/logo.jpg",
      gmbImage: "/images/Navbar/palamgmb.png",
    ...
    contact: {
      heading:    "Get in Touch – Palam",
      subheading: "Our Palam Dwarka team is ready to help you find your perfect Tata.",
      email:      "sm.dwarka@garudtata.com",
    },
    footer: { tagline: "Tata Motors Authorised Dealer · Palam, Dwarka, New Delhi" },
    ui:     SHARED_UI,
  },
  ...
  "Tata-Motors-Narela": {
    ...
    hero:           SHARED_HERO,
    seo: {
      title:       "Tata Motors Narela | New Tata Cars, Offers & Test Drive | Garud Tata",
      description: "Visit Garud Tata Narela, an authorised Tata Motors dealer in Narela, New Delhi. Explore new Tata cars, latest offers, test drives, finance and expert assistance.",
      canonical:   "https://www.tatamotors-delhi.com/Tata-Motors-Narela",
    },
    navbar: {
      logoSrc:  "/images/logo.jpg",
      gmbImage: "/images/Navbar/Narelagmb.png",
  ...
  "Tata-Motors-Najafgarh": {
    ...
    hero:           SHARED_HERO,
    seo: {
      title:       "Tata Motors Najafgarh | New Tata Cars, Offers & Test Drive | Garud Tata",
      description: "Visit Garud Tata Najafgarh, an authorised Tata Motors dealer in Najafgarh, New Delhi. Explore new Tata cars, latest offers, test drives, finance and expert assistance.",
      canonical:   "https://www.tatamotors-delhi.com/Tata-Motors-Najafgarh",
    },
    navbar: {
      logoSrc:  "/images/logo.jpg",
      gmbImage: "/images/Navbar/NajafgarhGmbimage.jpeg",
