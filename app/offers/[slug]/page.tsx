...
//     title,
//     description,
//     alternates: { canonical: `https://garudtata.com/offers/${offer.id}` },
//     openGraph: {
//       title,
//       description,
...
//     // ✅ searchParams completely removed — type param was causing auto-scroll
//   }
// ) {
//   const { slug } = await params;
//   const offer = getOfferBySlug(slug);
...
//       images={images}
//       heroImage={heroImage}
//       defaultType="Get Offer" // ✅ always "Get Offer" — never causes a scroll
//     />
//   );
// }
